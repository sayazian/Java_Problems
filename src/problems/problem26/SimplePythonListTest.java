...
class SimplePythonListTest {
    ...
    void testGet1() {
        SList<Integer> listOfLengthOne = Framework.buildListOfLengthOne();
        assertThrows(IndexOutOfBoundsException.class, () -> {
            listOfLengthOne.get(-10);
        });
        assertEquals(10, listOfLengthOne.get(0));
        assertEquals(10, listOfLengthOne.get(-1));
        assertThrows(IndexOutOfBoundsException.class, () -> {
    ...
    void testGet3() {
        SList<Integer> listOfLengthThree = Framework.buildListOfLengthThree();
        assertThrows(IndexOutOfBoundsException.class, () -> {
            listOfLengthThree.get(-10);
        });
        assertEquals(10, listOfLengthThree.get(0));
        assertEquals(11, listOfLengthThree.get(1));
        assertEquals(12, listOfLengthThree.get(2));
        assertEquals(10, listOfLengthThree.get(-3));
        assertEquals(11, listOfLengthThree.get(-2));
        assertEquals(12, listOfLengthThree.get(-1));
        assertThrows(IndexOutOfBoundsException.class, () -> {
    ...
    void testSet1() {
        SList<Integer> listOfLengthOne = Framework.buildListOfLengthOne();
        assertThrows(IndexOutOfBoundsException.class, () -> {
            listOfLengthOne.set(-10, 66);
        });
        listOfLengthOne.set(0, 66);
        assertEquals(66, listOfLengthOne.get(0));
        listOfLengthOne.set(-1, 77);
        assertEquals(77, listOfLengthOne.get(-1));
        assertThrows(IndexOutOfBoundsException.class, () -> {
    ...
    void testSet3() {
        ...
        listOfLengthThree.set(-3, 44);
        assertEquals(44, listOfLengthThree.get(-3));
        listOfLengthThree.set(-2, 55);
        assertEquals(55, listOfLengthThree.get(-2));
        listOfLengthThree.set(-1, 22);
        assertEquals(22, listOfLengthThree.get(-1));
    ...
    static class Framework {
        static SList<Integer> buildListOfLengthZero() {
            return new SimplePythonList<>(new SimpleLinkedList<>());
        }

        static SList<Integer> buildListOfLengthOne() {
            SimpleLinkedList<Integer> simpleLinkedList = new SimpleLinkedList<>();
            simpleLinkedList.add(0, 10);
            return new SimplePythonList<>(simpleLinkedList);
        }

        static SList<Integer> buildListOfLengthThree() {
            SimpleLinkedList<Integer> simpleLinkedList = new SimpleLinkedList<>();
            simpleLinkedList.add(0, 10);
            simpleLinkedList.add(1, 11);
            simpleLinkedList.add(2, 12);
            return new SimplePythonList<>(simpleLinkedList);
        }
    }
}
