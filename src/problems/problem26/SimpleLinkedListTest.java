...
class SimpleLinkedListTest {
    ...
    static class Framework {
        ...
        static SList<Integer> buildListOfLengthOne() {
            SimpleLinkedList<Integer> objectSimpleLinkedList = new SimpleLinkedList<>();
            objectSimpleLinkedList.head = new SimpleLinkedList.Node<>();
            objectSimpleLinkedList.head.value = 10;
            return objectSimpleLinkedList;
        }
        ...
        static SList<Integer> buildListOfLengthThree() {
            ...
            objectSimpleLinkedList.head = new SimpleLinkedList.Node<>();
            objectSimpleLinkedList.head.value = 10;
            objectSimpleLinkedList.head.next = new SimpleLinkedList.Node<>();
            objectSimpleLinkedList.head.next.value = 11;
            objectSimpleLinkedList.head.next.next = new SimpleLinkedList.Node<>();
            objectSimpleLinkedList.head.next.next.value = 12;
            return objectSimpleLinkedList;
        }
    }
}
